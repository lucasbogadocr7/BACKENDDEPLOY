...
export class PedidoController {
    ...
    async crear(req, res, next) {
        ...
        const compradorId = req.kauth.grant.access_token.content.sub;
        ...
        try {
          ...
          res.status(201).json(nuevoPedido.toObject());
 ...
 if (resultId.error) {
    ...
    const resultBody = modificarPedidoSchema.safeParse(req.body);
        ...
        try {  
            ...
            // se crea un nuevo objeto para evitar el error de serialización
